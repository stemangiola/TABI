...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(158, 156, "end", "model_DE_sigmoid");
    return reader;
}
...
class model_DE_sigmoid
  : public stan::model::model_base_crtp<model_DE_sigmoid> {
private:
        int prior_only;
        int G;
        int T;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            aux1_global = double(0);
            stan::math::fill(aux1_global, DUMMY_VAR__);
            stan::math::assign(aux1_global,2);
            current_statement_begin__ = 71;
            aux2_global = double(0);
            stan::math::fill(aux2_global, DUMMY_VAR__);
            stan::math::assign(aux2_global,1);
            current_statement_begin__ = 72;
            caux = double(0);
            stan::math::fill(caux, DUMMY_VAR__);
            stan::math::assign(caux,1);
            // execute transformed data statements
            // validate transformed data
            current_statement_begin__ = 69;
            check_greater_or_equal(function__, "scale_global", scale_global, 0);
            current_statement_begin__ = 70;
            check_greater_or_equal(function__, "aux1_global", aux1_global, 0);
            current_statement_begin__ = 71;
            check_greater_or_equal(function__, "aux2_global", aux2_global, 0);
            current_statement_begin__ = 72;
            check_greater_or_equal(function__, "caux", caux, 0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::model::assign(beta, 
                        ...
                        to_row_vector(get_base1(beta1_z, 1, "beta1_z", 1)), 
            ...
            for (int r = 1; r <= R_1; ++r) {
                current_statement_begin__ = 124;
                lp_accum__.add(normal_log<propto__>(get_base1(beta1_z, r, "beta1_z", 1), 0, 2));
            }
            current_statement_begin__ = 125;
            lp_accum__.add(normal_log<propto__>(inflection, 0, 5));
            current_statement_begin__ = 126;
            lp_accum__.add(normal_log<propto__>(log_y_cross, 0, 2));
            ...
            if (as_bool(logical_eq(prior_only, 0))) {
                ...
                for (int t = 1; t <= T; ++t) {
                    current_statement_begin__ = 142;
                    lp_accum__.add(neg_binomial_2_log_log<propto__>(get_base1(y, t, "y", 1), get_base1(y_hat, t, "y_hat", 1), get_base1(overdispersion, t, "overdispersion", 1)));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            ...
            for (int t = 1; t <= T; ++t) {
                ...
                for (int g = 1; g <= G; ++g) {
                    ...
                    stan::model::assign(y_gen, 
                                ...
                                neg_binomial_2_log_rng(get_base1(get_base1(y_hat, t, "y_hat", 1), g, "y_hat", 2), get_base1(get_base1(overdispersion, t, "overdispersion", 1), g, "overdispersion", 2), base_rng__), 
