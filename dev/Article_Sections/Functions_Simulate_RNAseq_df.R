...
# Set of covar values which are going to correspond to the x values for each sample
  ...
  # sample<-lapply(log_y_hat, function(x) rnbinom(mu = exp(x), 
  #                                            size = disp_size, 
  #                                            n = 1))
  ...
  #                     function(x) 
  #                       log_y_hat = (rnbinom(n=sample_size,
  #                                mu = x, 
  #                                size = disp_size)))
  # 
...
#' 
#' 
#' @param sim_df Dataframe of simulated read counts (outcome of sigmoidal_sim_df function)
#' 
#' @param type  What type of transcript do you want to randomly select - differentially abundant/expressed (let = "DE"), null (= "null"), or "any" 
#' 
#' @export
